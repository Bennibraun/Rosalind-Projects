...
# CACGTCAATCAC
# CAATAATATTCG
# print('\n'.join(greedy_motif_search_with_laplace(['GGCGTTCAGGCA','AAGAATCAGTCA','CAAGGAGTTCGC','CACGTCAATCAC','CAATAATATTCG'],3,5)))
...
print('\n'.join(greedy_motif_search_with_laplace(dna,k,t)))
